...
healthServer.listen(port, () => {
    utils_1.logger.info(`[${'notification'.toUpperCase()}] Health endpoint listening on port ${port}`);
});
// ---------------------------
const constants_1 = require("@thronova/constants");
const bullmq_1 = require("bullmq");
const shared_1 = require("@thronova/shared");
utils_1.logger.info("Starting notification worker...");
const worker = new bullmq_1.Worker(constants_1.QUEUES.NOTIFICATION, async (job) => {
    utils_1.logger.info("Processing notification job:", job.id);
