...
healthServer.listen(port, () => {
    utils_1.logger.info(`[${'render'.toUpperCase()}] Health endpoint listening on port ${port}`);
});
// ---------------------------
...
const RemotionRunner_1 = require("./RemotionRunner");
// Initialize Dependency Injection
services_1.renderService.registerRunner(new RemotionRunner_1.RemotionRunner());
utils_1.logger.info("Starting render worker...");
const worker = new bullmq_1.Worker(constants_1.QUEUES.RENDER, async (job) => {
    utils_1.logger.info("Processing render job:", job.id);
